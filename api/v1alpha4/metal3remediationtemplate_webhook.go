...
var (
	// Default retry timeout is 100 seconds.
	defaultTimeout = metav1.Duration{Duration: 100 * time.Second}
...
// +kubebuilder:webhook:path=/mutate-infrastructure-cluster-x-k8s-io-v1alpha4-metal3remediationtemplate,mutating=true,failurePolicy=fail,groups=infrastructure.cluster.x-k8s.io,resources=metal3remediationtemplates,verbs=create;update,versions=v1alpha4,name=mmetal3remediationtemplate.kb.io
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-infrastructure-cluster-x-k8s-io-v1alpha4-metal3remediationtemplate,mutating=false,failurePolicy=fail,groups=infrastructure.cluster.x-k8s.io,resources=metal3remediationtemplates,versions=v1alpha4,name=vmetal3remediationtemplate.kb.io
